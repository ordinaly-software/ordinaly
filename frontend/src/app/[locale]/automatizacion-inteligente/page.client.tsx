    ...
    <div className="relative z-20 isolate bg-white dark:bg-neutral-900 transition-colors">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-16 max-w-5xl mx-auto px-6">
          {content.steps.map((step: string, i: number) => (
            <div key={i} className="relative flex flex-col items-center group">
              <div className="w-44 h-28 rounded-xl border border-neutral-300 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-800 shadow-sm flex items-center justify-center transition-all duration-300 group-hover:border-[#d97706] group-hover:bg-[#d97706]/10">
                <div className="transition-all duration-300 group-hover:text-[#d97706] text-neutral-600 dark:text-neutral-400">

                  {i === 0 && (
                    <svg width="34" height="34" viewBox="0 0 24 24" fill="none" className="stroke-current">
              ...
              {i < content.steps.length - 1 && (
                <div className="hidden md:block absolute top-14 left-full w-24 h-[2px] bg-neutral-300 dark:bg-neutral-700 group-hover:bg-[#d97706] transition-all duration-300" />
              )}
            </div>
          ))}
        </div>
      ...
      <section className="py-24 bg-neutral-50 dark:bg-neutral-800 transition-colors">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
          {content.benefits.map((benefit: string, i: number) => {
            const icons = [
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="stroke-[#d97706]"><path d="M5 13l4 4L19 7" strokeWidth="2" /></svg>,
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="stroke-[#d97706]"><path d="M13 2L3 14h7l-1 8 10-12h-7l1-8z" strokeWidth="2" /></svg>,
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="stroke-[#d97706]"><path d="M6 4v6a4 4 0 004 4h4m4-10v6a4 4 0 01-4 4h-4" strokeWidth="2" /></svg>,
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="stroke-[#d97706]"><path d="M12 3a4 4 0 00-4 4v1H7a4 4 0 000 8h1v1a4 4 0 008 0v-1h1a4 4 0 000-8h-1V7a4 4 0 00-4-4z" strokeWidth="2" /></svg>,
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="stroke-[#d97706]"><path d="M12 8v8m-4-4h8M12 2a10 10 0 110 20" strokeWidth="2" /></svg>,
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="stroke-[#d97706]"><circle cx="12" cy="12" r="9" strokeWidth="2" /><path d="M12 7v5l3 3" strokeWidth="2" /></svg>,
            ];
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-3 h-3 rounded-full bg-neutral-400 dark:bg-neutral-600 group-hover:bg-[#d97706] transition-all duration-300" />
                  {icon}
                </div>
                ...
                <div className="absolute inset-0 bg-[#d97706] opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
              </WobbleCard>
            );
          })}
        </div>
      ...
      >
        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          <path d="M20.52 3.48A11.8 11.8 0 0 0 12.04 0C5.46 0 .1 5.36.1 11.94c0 2.1.55 4.15 1.6 5.96L0 24l6.3-1.64a12 12 0 0 0 5.74 1.46h.01c6.58 0 11.94-5.36 11.94-11.94 0-3.19-1.24-6.19-3.47-8.4Z" />
        </svg>
