                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-300 bg-gray-50 py-3 pl-10 pr-4 text-base text-gray-900 transition-all focus:ring-2 focus:ring-[#1F8A0D] dark:border-gray-600 dark:bg-gray-800/50 dark:text-white dark:focus:ring-[#3FBD6F]"
