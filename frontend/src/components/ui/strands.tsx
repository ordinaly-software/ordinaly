...
// Adapted from reactbits.dev's "Strands" animation (DavidHDev/react-bits,
// src/ts-tailwind/Animations/Strands). Recolored to the site's clay/flame/ivory
// brand palette instead of the demo's red/purple/cyan/yellow.
...
// Brand palette: clay, flame and ivory-light (see globals.css --swatch--*).
const BRAND_COLORS = ["#D97757", "#E15D31", "#FAF9F5", "#D97757"];
...
export default function Strands({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uTime.value = prefersReducedMotion ? 0 : t * 0.001;
