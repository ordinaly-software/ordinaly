      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            ...
            {/* Featured Badge */}
            {service.is_featured && (
              <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400 mt-2">
                {t("services.featured")}
              </div>
            )}
          </div>
