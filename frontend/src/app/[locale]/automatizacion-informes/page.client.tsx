...
export default function AutomatizacionInformes() {
  ...
  const howItWorksSteps: { title: string; description: string }[] = content.howItWorks?.steps ?? [];
  ...
  const infocards: InfoCardItem[] = [
    {
      key: "workflow",
      size: "xl",
      image: "/static/automatizacion-informes/workflow.webp",
    },
    {
      key: "software",
      size: "sm",
      ...
      image: "/static/automatizacion-informes/software.webp",
    },
    {
      key: "compatibilidad",
      size: "xl",
      ...
      image: "/static/automatizacion-informes/compatibilidad.webp",
    },
    {
      key: "vps",
      size: "md",
      ...
      image: "/static/automatizacion-informes/vps.webp",
    },
    {
      key: "sensitive-data",
      size: "md",
      ...
      image: "/static/automatizacion-informes/sensitive_data.webp",
    },
    ...requirementsCard,
    ...pricingCard,
  ];
    ...
    <div className="relative z-20 isolate bg-white dark:bg-neutral-900 transition-colors">
      ...
      <section className="relative w-full min-h-[36rem] flex items-center justify-center overflow-hidden py-24 px-6">
        <div
          ...
          style={{ backgroundImage: "url('/static/automatizacion-informes/automatizacion_informes.webp')" }}
        />
