    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 min-w-0">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
        ...
        <Button
          ...
          size="sm"
          className="bg-[#0d6e0c] dark:bg-[#3FBD6F] hover:bg-[#0A4D08] text-white flex items-center gap-1 whitespace-nowrap px-2 sm:px-3 min-w-[140px] justify-center w-full sm:w-auto disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-6">
          <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#1F8A0D] dark:border-[#3FBD6F]"></div>
        </div>
              ...
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  <div className="w-8 h-8 bg-[#1F8A0D]/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <User className="h-4 w-4 text-[#1F8A0D] dark:text-[#3FBD6F]" />
                  </div>
