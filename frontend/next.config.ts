      ...
      },
{
  ...
  async redirects() {
    return [
      ...
      { source: '/automatizacion-n8n-sevilla', destination: '/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/en/automatizacion-n8n-sevilla', destination: '/en/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/automatizacion-inteligente', destination: '/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/en/automatizacion-inteligente', destination: '/en/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/automatizacion-n8n', destination: '/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/en/automatizacion-n8n', destination: '/en/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/automatizaciones-personalizadas', destination: '/automatizaciones-personalizadas-empresas-n8n', permanent: true },
      { source: '/en/automatizaciones-personalizadas', destination: '/en/automatizaciones-personalizadas-empresas-n8n', permanent: true },
