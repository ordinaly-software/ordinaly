    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <button
            onClick={openModal}
            className="relative bg-[#0d6e0c] dark:bg-[#7CFC00] hover:bg-[#0A4D08] text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110 group"
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#23272F] text-gray-900 dark:text-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-6">
              <div className="mb-6">
                <div className="bg-gradient-to-r from-[#1F8A0D]/10 dark:from-[#7CFC00]/10 to-[#2BCB5C]/10 dark:to-[#0F3D08] p-4 rounded-lg border border-gray-200 dark:border-gray-700 mb-4">
