    ...
    <>
      ...
      >
        <div className="relative">
          {/* Pulse animation */}
          <div className="absolute inset-0 bg-[#22A60D] rounded-full animate-ping opacity-30"></div>
          
          <button
            onClick={openModal}
            className="relative bg-[#22A60D] hover:bg-[#20c55a] text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 group"
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full bg-[#22A60D] hover:bg-[#20c55a] text-white py-3 flex items-center justify-center space-x-2 transition-all duration-200"
                >
