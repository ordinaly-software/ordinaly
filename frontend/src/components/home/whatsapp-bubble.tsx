    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <button
            onClick={openModal}
            className="relative bg-[#0d6e0c] dark:bg-[#7CFC00] hover:bg-[#0A4D08] text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 group"
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full bg-[#0d6e0c] dark:bg-[#7CFC00] hover:bg-[#0A4D08] text-white py-3 flex items-center justify-center space-x-2 transition-all duration-200"
                >
