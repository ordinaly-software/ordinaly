    ...
    >
      <div className="relative">
        ...
        <div className={variant === "upcoming" ? "relative h-72 md:h-80 lg:h-96 overflow-hidden" : "relative h-48 overflow-hidden"}>
          ...
          {variant === "past" ? (
            ...
            <>
              ...
              {enrolled && (
                <div className="absolute top-4 right-4 z-10">
                  <div className="bg-clay text-white px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1">
        ...
        <CardContent className={variant === "upcoming" ? "p-8" : "p-6"}>
          {/* Course Title */}
          <h3 className={`font-bold text-gray-900 dark:text-white mb-3 break-words whitespace-pre-line ${variant === "upcoming" ? "text-2xl group-hover:text-clay transition-colors duration-300" : "text-xl"}`}>
            {course.title}
          </h3>
            ...
            {isPastVariant ? (
              <>
                <Button
                  ...
                  variant="flame"
                  className="w-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 h-14 text-lg"
                >
                  {t("wantNewEdition")}
                </Button>
                <Button
              ...
              <>
                ...
                <Button
                  variant="outline"
                  onClick={handleViewDetailsClick}
                  className="w-full border-clay text-clay hover:bg-clay hover:text-white h-14 text-lg transition-all duration-300"
                >
                  {t("viewDetails")}
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
      ...
      {variant === "upcoming" && <div className="absolute inset-0 bg-gradient-to-br from-clay/5 to-cobalt/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>}
    </Card>
  );
};
