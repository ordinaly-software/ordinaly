  ...
  return (
    <div className={cn("flex h-full w-full items-center justify-center px-6 py-8", className)}>
      <div className="flex max-w-sm flex-col items-center gap-3 text-center">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#0255D5]/15 text-[#0255D5] dark:text-[#7DB5FF]">
        ...
        <Button size="sm" className="bg-[#0144AA] text-white dark:bg-[#7DB5FF] dark:text-black" onClick={handleAction}>
