        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-[#0d6e0c] hover:bg-[#0A4D08] dark:bg-[#3FBD6F] dark:hover:bg-[#2EA55E] text-white dark:text-black rounded-full flex items-center justify-center transition-colors shadow-lg"
              aria-label="LinkedIn Ordinaly Software"
            >
