  ...
  return (
    <div className={cn("flex h-full w-full items-center justify-center px-6 py-8", className)}>
      <div className="flex max-w-sm flex-col items-center gap-3 text-center">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1F8A0D]/15 text-[#1F8A0D] dark:text-[#7CFC00]">
        ...
        <Button size="sm" className="bg-[#0d6e0c] text-white dark:bg-[#7CFC00] dark:text-black" onClick={handleAction}>
