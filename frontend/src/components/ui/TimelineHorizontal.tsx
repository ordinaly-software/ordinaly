        ...
        <div className="relative flex justify-between w-full">
          {steps.map((_, index) => (
            <motion.div
              ...
              className="flex items-center justify-center w-12 h-12 bg-white border-2 border-neutral-400 rounded-full shadow-md text-neutral-700 font-semibold text-lg"
            >
              {index + 1}
            </motion.div>
          ))}
