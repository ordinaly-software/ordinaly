    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <button
            onClick={openModal}
            className="relative bg-[#25D366] hover:bg-[#20c55a] text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 group"
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card text-card-foreground rounded-2xl shadow-2xl max-w-md w-full border border-border overflow-hidden">
            ...
            <div className="p-6">
              <div className="mb-6">
                <div className="bg-gradient-to-r from-[#25D366]/10 to-[#20c55a]/10 p-4 rounded-lg border border-border mb-4">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={index} className="flex items-center space-x-2 text-sm text-muted-foreground">
                        <div className="w-1.5 h-1.5 bg-[#25D366] rounded-full flex-shrink-0"></div>
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full bg-[#25D366] hover:bg-[#20c55a] text-white py-3 flex items-center justify-center space-x-2 transition-all duration-200"
                >
