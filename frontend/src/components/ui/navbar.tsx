...
import { Menu, X, User, LogOut, LogIn, Settings, BookOpen } from "lucide-react";
                    ...
                    <AnimatePresence>
                      {isMenuOpen && (
                        <motion.div
                          ...
                          exit={{ opacity: 0, y: -8 }}
                          transition={{ duration: 0.2 }}
                          className="absolute right-0 mt-2 w-56 rounded-xl border border-gray-200 dark:border-gray-700/70 bg-white/95 dark:bg-[#1A1924]/95 shadow-lg backdrop-blur-sm overflow-hidden z-50"
                        >
