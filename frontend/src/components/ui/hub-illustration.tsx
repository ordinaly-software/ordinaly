...
const BG_THEME: Record<HubBgTheme, {
  ...
  green: {
    bgFromLight: "#FAF9F5", bgToLight: "#F0EEE6",
    bgFromDark:  "#141413", bgToDark:  "#3D3D3A",
    ringLight:   "#E3DACC", ringDark:  "#3D3D3A",
    dotLight:    "#E3DACC", dotDark:   "#3D3D3A",
    glowColor: "#D97757", pulseColor: "#D97757",
    hubLeft0: "#D97757", hubLeft1: "#C6613F",
    hubRight0: "#E15D31", hubRight1: "#C04E28",
    hubTopFromLight: "#FAF9F5", hubTopToLight: "#F0EEE6",
    hubTopFromDark:  "#3D3D3A", hubTopToDark:  "#141413",
    titleLight: "#141413", titleDark: "#FAF9F5",
    subtitleLight: "#D97757", subtitleDark: "#E3DACC",
    wordmarkFill: "white", wordmarkSub: "#E3DACC",
  },
  cyan: {
